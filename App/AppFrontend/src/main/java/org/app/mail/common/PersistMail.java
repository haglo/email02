...
public class PersistMail implements Const {
	...
	public void saveMail(Message message, EmailService service, MAIL_TYPE mt) {
		String tmp = "";
		String pathDef = null;
		...
		if (mt.equals(MAIL_TYPE.IMAP)) {
			...
			pmail.setPmailFolder01(service.getPmailFolder01DAO().findByFoldername("Inbox"));
		...
		if (mt.equals(MAIL_TYPE.SMTP)) {
			pathDef = getSmtpID();
			pmail.setPmailFolder01(service.getPmailFolder01DAO().findByFoldername("Sent"));
		}
